...
public class AddBakingRecipeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddBakingRecipeActivity.this, HomeActivity.class);
    ...
    private void addBakingRecipeToDatabase() {
        ...
        if (!recipeName.isEmpty() && !ingredients.isEmpty() && !preparation.isEmpty()) {
            long result = dbHelper.addBakingRecipe(recipeName, ingredients, preparation, "0");
